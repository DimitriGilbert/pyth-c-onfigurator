...
//		insertion du form dans la page
	...
	this.new_cp=function()
	{
		...
		//from
		div.appendChild(jsi.input4form(id+'_path',"Chemin à copier",[],[],''));
		//to
		div.appendChild(jsi.input4form(id+'_path',"Chemin de destination",[],[],''));
		//type
		div.appendChild(jsi.input4form(id+'_mode',"file ou dir",[],[],'file'));
		//r
		div.appendChild(jsi.input4form(id+'_mode',"recursif (si dir seulement)",[],[],'1'));
//		insertion du form dans la page
		return t.script_detail.appendChild(div);
	}
